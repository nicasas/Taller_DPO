...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el país al que representa un atleta.
	 */
	public String buscarPaisAtleta(String NombreAtleta)
	{
		Atleta atletaSelecionado = buscarAtleta(NombreAtleta);
		Pais paisDelSenor = atletaSelecionado.darPais();
		String resp = paisDelSenor.darNombre();
		return resp;
	}
	 ...
	 * 
	 * Si un atleta ha participado
	 *  en el mismo deporte en años diferentes, sólo se
	 * cuenta una vez.
	 * 
