...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país al que atleta representa");
	...
	/**
	 *Le informa al usuario el nombre del país el cual representa un atleta. 
	 */
	private void ejecutarAtletaDeUnPais()
	{
		System.out.println("\n"+"El atleta representa a"+"\n");
		String atleta= input("Por favor ingrese el nombre de un Atleta");
		String nombrePais = calculadora.buscarPaisAtleta(atleta);
		System.out.println("El atleta " + atleta + "representa el pais " + nombrePais);
	...
	private void ejecutarCargarAtletas()
	{
		...
		String archivo =System.getProperty("user.dir")+"/data/"+ input("Por favor ingrese el nombre del archivo CSV con los atletas");
		try
		{	
